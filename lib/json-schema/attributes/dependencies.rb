  ...
  class Schema
    class DependenciesAttribute < Attribute
      ...
      def self.validate_dependency(schema, data, property, value, fragments, processor, attribute, options)
        ...
        validation_error(processor, message: message, fragments: fragments, properties: [property], schema: schema, failed_attribute: attribute, record_errors: options[:record_errors])
      end
